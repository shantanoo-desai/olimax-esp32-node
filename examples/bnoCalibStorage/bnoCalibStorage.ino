/*
 * This Sketch provides an example to store information in the ESP32's
 * Non-Volatile Storage (NVS) using `Preferences`.
 * This sketch stores the Calibration Offsets of Accelerometer, Magnetometer,
 * Gyroscope from BNO055. This information stored can be accessed the next time
 * the Node is powered up.
 *
 * NOTE: This code uses function from `Adafruit_BNO055` examples and `Preferences` example
 *
...
Preferences Calibration; // use Preferences called `Calibration`
...
void setup(void)
{
   ...
   // Use namespace `offsets` to store offset values
   Calibration.begin("offsets", false);
   // Calib. Data
   adafruit_bno055_offsets_t calibrationData;
   sensor_t sensor;

   // search for sensor's ID
